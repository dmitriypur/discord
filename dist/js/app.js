(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-devices")) new swiper_core_Swiper(".swiper-devices", {
            modules: [ Autoplay ],
            slidesPerView: "auto",
            spaceBetween: 90,
            speed: 5e3,
    ...
    Array.from(iframeVideo).forEach((function(elem, i) {
        ...
        if (src.indexOf("youtube.com") != -1) {
            ...
            parentDiv.replaceChild(videoBox, elem);
    ...
    let titleReplace = document.querySelector(".title__replace");
    window.addEventListener("resize", (function() {
        if (window.innerWidth < 1441) if (titleReplace.innerHTML == "Безопасность и&nbsp;конфиденциальность") document.querySelector(".title__replace").innerHTML = "Конфиденциальность и&nbsp;безопасность";
    }));
    window.addEventListener("scroll", (function(e) {
